    ...
    <div className="space-y-6">
      ...
      <div className="card p-4 sm:p-6">
        ...
        <div className="text-xs sm:text-sm text-gray-600 space-y-1.5 sm:space-y-2">
          ...
          <p>
            • При равенстве очков выше стоит игрок с меньшим числом турниров
          </p>
          <p>• Результаты, участвующие в сумме рейтинга - выделены цветом</p>
          <p>
            • В таблице — игроки с лицензией на год расчёта; также игроки только с
            лицензией прошлого года, если у них есть очки в скользящем окне 365 дней
          </p>
        </div>
      </div>
    </div>
