    ...
    <article className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8 text-gray-700 leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-gray-600">
          ...
          может загружать/редактировать/удалять турниры, а также не имеет
          доступа к игрокам (кроме клубов), лицензиям, пользователям,
          настройкам и аудиту.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-gray-600">
          ...
          удалять игроков и владеть более чем одним клубом.
        </p>
      </section>
