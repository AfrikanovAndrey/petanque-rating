    ...
    <article className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8 text-gray-700 leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-gray-600">
          ...
          менять организатора турнира, менять глобальные настройки рейтинга и
          просматривать аудит.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 mb-2">
          ...
          «Справка». Создатель турнира становится его организатором и может
          менять данные только своих турниров. Нет доступа к разделу
          «Лицензии», панели управления, учётным записям других пользователей,
          логам аудита и настройкам системы.
        </p>
      </section>
